...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 29, 2024 at 09:00 AM
...
INSERT INTO `patient` (`HN`, `First_Name`, `Last_Name`, `Birthdate`, `Phone`, `Gender`, `Title`, `Allergy_ID`, `disease_id`) VALUES
('HN001', 'สมชาย', 'สุขใจ', '1980-05-12', '0812345678', 'ชาย', 'นาย', NULL, NULL),
('HN002', 'สมหญิง', 'ใจดี', '1985-08-22', '0823456789', 'หญิง', 'นาง', NULL, NULL),
('HN003', 'สมศักดิ์', 'ใจสู้', '1975-03-18', '0834567890', 'ชาย', 'นาย', NULL, NULL),
('HN004', 'สมพร', 'ใจบุญ', '1990-11-05', '0845678901', 'หญิง', 'นางสาว', NULL, NULL),
('HN005', 'สมหมาย', 'ใจถึง', '1968-07-29', '0856789012', 'ชาย', 'นาย', NULL, NULL),
('HN006', 'สมใจ', 'ใจเย็น', '1995-02-14', '0867890123', 'หญิง', 'นางสาว', NULL, NULL),
('HN007', 'สมบูรณ์', 'ใจกว้าง', '1972-09-03', '0878901234', 'ชาย', 'นาย', NULL, NULL),
('HN008', 'สมปอง', 'ใจดี', '1988-04-20', '0889012345', 'หญิง', 'นาง', NULL, NULL),
('HN009', 'สมหวัง', 'ใจมั่น', '1965-12-31', '0890123456', 'ชาย', 'นาย', NULL, NULL),
('HN010', 'สมนึก', 'ใจสบาย', '1992-06-26', '0901234567', 'หญิง', 'นางสาว', NULL, NULL),
('HN011', 'สมคิด', 'ใจเด็ด', '1978-10-15', '0912345678', 'ชาย', 'นาย', NULL, NULL),
('HN012', 'สมทรง', 'ใจงาม', '1983-01-08', '0923456789', 'หญิง', 'นาง', NULL, NULL),
('HN013', 'สมาน', 'ใจดี', '1997-09-23', '0934567890', 'ชาย', 'นาย', NULL, NULL),
('HN014', 'สมหญิง', 'ใจบุญ', '1966-06-11', '0945678901', 'หญิง', 'นาง', NULL, NULL),
('HN015', 'สมชาย', 'ใจสู้', '1989-03-07', '0956789012', 'ชาย', 'นาย', NULL, NULL),
('HN016', 'สมใจ', 'ใจเย็น', '1974-12-25', '0967890123', 'หญิง', 'นางสาว', NULL, NULL),
('HN017', 'สมศักดิ์', 'ใจกว้าง', '1991-08-19', '0978901234', 'ชาย', 'นาย', NULL, NULL),
('HN018', 'สมพร', 'ใจดี', '1986-05-04', '0989012345', 'หญิง', 'นาง', NULL, NULL),
('HN019', 'สมหมาย', 'ใจมั่น', '1970-02-28', '0990123456', 'ชาย', 'นาย', NULL, NULL),
('HN020', 'สมนึก', 'ใจสบาย', '1994-11-17', '0812345678', 'หญิง', 'นางสาว', NULL, NULL);
...
(1, 'Nurse', 'Nurse', 1, '2778199430abc5066decba6c32cb0c51'),
(2, 'Doctor', 'Doctor', 0, '7657b87ab17604b289472dfaad81fff0');
...
--
ALTER TABLE `patient`
  ADD CONSTRAINT `patient_ibfk_1` FOREIGN KEY (`Allergy_ID`) REFERENCES `allergy` (`Allergy_ID`);
