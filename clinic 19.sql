...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2024 at 09:41 PM
...
('HN002', '2024-10-13', '00:00:00'),
('HN002', '2024-10-25', '00:00:00'),
('HN002', '2024-10-30', '00:00:00');
...
--
-- Dumping data for table `general_treatment`
--

INSERT INTO `general_treatment` (`General_ID`, `Treatment_ID`, `General_Details`, `Treatment_Detail`, `Treatment_Others`) VALUES
('gt00001', NULL, 'ทั่วไป', 'ทั่วไป', 'ทั่วไป'),
('gt00002', 'T00085', 'p', 'p', 'p');
...
('O00091', 'HN002', '2024-10-19', 301, 0.00),
('O00092', 'HN005', '2024-10-20', 0, 0.00),
('O00093', 'HN006', '2024-10-20', 0, 0.00);
...
CREATE TABLE `pregnancy_treatment` (
  `Pregnan_ID` varchar(10) NOT NULL,
  `Treatment_ID` varchar(10) DEFAULT NULL,
...
--
-- Dumping data for table `pregnancy_treatment`
--

INSERT INTO `pregnancy_treatment` (`Pregnan_ID`, `Treatment_ID`, `Pregnancy_Control_Type`, `Last_Control_Date`, `Freq_Pregnancies`, `Pregnancy_Problems`, `Total_Pregnancies`, `Total_Children`, `Last_Pregnancy_Date`, `Abortion_History`, `Pregmed_Detail`, `Preg_Others`) VALUES
('PT00001', 'T00085', NULL, NULL, NULL, '33', NULL, NULL, NULL, NULL, 'd', 'd');
...
('T00086', 'HN005', 'O00092', '2024-10-20', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('T00087', 'HN006', 'O00093', '2024-10-20', NULL, '77', '55', '66', '33', '333', '33');
...
(1, 'HN002', '18:30:38', 'รอจ่ายยา', '2024-10-19', '2024-10-19 11:22:38'),
(2, 'HN005', '18:45:38', 'รอตรวจ', '2024-10-20', '2024-10-19 19:17:32'),
(3, 'HN006', '19:00:38', 'รอตรวจ', '2024-10-20', '2024-10-19 19:19:00');
...
ALTER TABLE `general_treatment`
  ...
  ADD KEY `fk_treatment_id_general` (`Treatment_ID`);
...
ALTER TABLE `pregnancy_treatment`
  ADD PRIMARY KEY (`Pregnan_ID`),
  ADD KEY `fk_treatment_id_pregnancy` (`Treatment_ID`);
...
--
ALTER TABLE `general_treatment`
  ADD CONSTRAINT `fk_treatment_id_general` FOREIGN KEY (`Treatment_ID`) REFERENCES `treatment` (`Treatment_ID`) ON DELETE CASCADE,
...
--
ALTER TABLE `pregnancy_treatment`
  ADD CONSTRAINT `fk_treatment_id_pregnancy` FOREIGN KEY (`Treatment_ID`) REFERENCES `treatment` (`Treatment_ID`) ON DELETE CASCADE,
